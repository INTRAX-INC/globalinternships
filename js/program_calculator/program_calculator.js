...
var programCalculator = (function($) {
  var options = {
    ...
    templateLocation: 'https://cdn.jsdelivr.net/gh/intrax-inc/globalinternships@latest/html/programCalculatorTemplate.html',
    handlebarsTemplateInternalName: 'programCalculatorTemplate.html',
    mainContainer: '#program-calculator',
    csv_location: 'https://cdn.jsdelivr.net/gh/intrax-inc/globalinternships@latest/js/program_calculator/premium_prices.csv'
  };
